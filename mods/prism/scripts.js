...
exports.BattleScripts = {
	...
	getDamage: function (pokemon, target, move, suppressMessages) {
		...
		// Increase Rock Type's SpD in Sand. May be superfluous because adding to gen 2 damage calc, when may already be calc'd in gen 4
		// Fix later if needed
		if (this.isWeather('sandstorm' && target.type === 'Rock' && defType === 'spd') {
		    	defense = defense * 1.5;
		}
